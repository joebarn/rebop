      ...
      try {
        ...
        ShowAstTree();
            ...
            if (file!=null)
            {
                ...
                sb.Append($"{FormatInteger(rof.Start)}{Environment.NewLine}");
                sb.Append($"{FormatInteger(rof.End)}{Environment.NewLine}");
                ...
                {
                    sb.Append($"{FormatInteger(rof.Image[i])}{Environment.NewLine}");
                }

                sb.Append($"END OF DATA");

                txtRasm.Text = sb.ToString();
